...
SCRIPT_DIR="experiments/dipart10_9_bugfixed/scripts/"
DATA_DIR="data/dipart10_9"
...
OUT_DIR="experiments/dipart10_9_bugfixed/output/"
EXPERIMENT_NAME="$DATA_SPLIT/9_bugfixed/pnp/"
