...
SCRIPT_DIR="experiments/dipart10_varypart_2/scripts/"
DATA_DIR="data/dipart10_varypart_2"
...
OUT_DIR="experiments/dipart10_varypart_2/output/"
EXPERIMENT_NAME="$DATA_SPLIT/varypart_2/pnp/"
