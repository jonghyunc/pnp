...
SCRIPT_DIR="experiments/dipart10_9_resize/scripts/"
DATA_DIR="data/dipart10_9_resize"
...
OUT_DIR="experiments/dipart10_9_resize/output/"
EXPERIMENT_NAME="$DATA_SPLIT/9_resize/pnp_update/"
