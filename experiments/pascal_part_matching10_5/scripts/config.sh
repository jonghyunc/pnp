...
SCRIPT_DIR="experiments/pascal_part_matching10_5/scripts/"
DATA_DIR="data/pascal_part_matching10_5"
...
OUT_DIR="experiments/pascal_part_matching10_5/output/"
EXPERIMENT_NAME="$DATA_SPLIT/5/pnp/"
